...
|---|---|---|---|
| Side-Pitch-Deck-2023-excerpt.pdf | 2023 investor deck (15 slides) | Slides 7 (partnership vision), 9 (pricing), 10 (client testimonial), 11 (market-size estimates), 12 (financial projections), 14 (investment ask). Title page added. | The 2023 deck as pitched, nine of fifteen slides. |
...
| img/presale-database.png | Airtable "Main Presale Data Base" screenshot | Top bar and right-edge widget cropped. Downscaled. | The production data layer: 17 linked tables, 374 projects, ingested by browse.ai tasks with per-row extract timestamps. |
